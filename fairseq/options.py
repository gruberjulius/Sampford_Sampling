...
def add_generation_args(parser):
    ...
    group.add_argument('--num-experiments', default=1, type=int, metavar='N',
                       help='for repeated experiments: number of times the command should run')
    ...
    group.add_argument('--naive-stochastic-beam-search', action='store_true',
                       help='Use naive stochastic Beam Search (e.g. sample without replacement with sampling-temperature)')
    group.add_argument('--sampford', action='store_true',
                       help='Use sampford sampling')
